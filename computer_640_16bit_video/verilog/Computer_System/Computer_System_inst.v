	Computer_System u0 (
		...
		.my_pio_beta_external_connection_export          (<connected-to-my_pio_beta_external_connection_export>),          //     my_pio_beta_external_connection.export
		.my_pio_clknew_external_connection_export        (<connected-to-my_pio_clknew_external_connection_export>),        //   my_pio_clknew_external_connection.export
		.my_pio_reset_external_connection_export         (<connected-to-my_pio_reset_external_connection_export>),         //    my_pio_reset_external_connection.export
		.my_pio_rho_external_connection_export           (<connected-to-my_pio_rho_external_connection_export>),           //      my_pio_rho_external_connection.export
		.my_pio_sigma_external_connection_export         (<connected-to-my_pio_sigma_external_connection_export>),         //    my_pio_sigma_external_connection.export
		.my_pio_x0_external_connection_export            (<connected-to-my_pio_x0_external_connection_export>),            //       my_pio_x0_external_connection.export
		.my_pio_xnew_external_connection_export          (<connected-to-my_pio_xnew_external_connection_export>),          //     my_pio_xnew_external_connection.export
		.my_pio_y0_external_connection_export            (<connected-to-my_pio_y0_external_connection_export>),            //       my_pio_y0_external_connection.export
		.my_pio_ynew_external_connection_export          (<connected-to-my_pio_ynew_external_connection_export>),          //     my_pio_ynew_external_connection.export
		.my_pio_z0_external_connection_export            (<connected-to-my_pio_z0_external_connection_export>),            //       my_pio_z0_external_connection.export
		.my_pio_znew_external_connection_export          (<connected-to-my_pio_znew_external_connection_export>),          //     my_pio_znew_external_connection.export
		...
		.audio_pll_ref_clk_reset_reset                   (<connected-to-audio_pll_ref_clk_reset_reset>),                   //             audio_pll_ref_clk_reset.reset
